...
class Config:
    try:
        ...
        config_name = '/home/bimi/users/Elahe/Clean_intagribot' + '/config/' + 'config.yaml'
    except:
    ...
    neural_net_yaml = '/home/bimi/users/Elahe/Clean_intagribot'+ '/config/neural_net/' + neural_net_yaml_name + '.yaml'
    ...
    data_collection_yaml = '/home/bimi/users/Elahe/Clean_intagribot' + '/config/data_collection/' + data_collection_yaml_name + '.yaml'
    ...
    run_neural_yaml = '/home/bimi/users/Elahe/Clean_intagribot' + '/config/run_neural/' + run_neural_yaml_name + '.yaml'
